...
charecters = [
    ...
    Cheater('chiter', 'Cheater.png', (10, 8)),
...
# monsters
monsters = [
    Monster('little_monster', 'litel_monster.png', (10, 2), 2, 1),
    Monster('big_monster', 'big_monster.png', (10, 4), 1, 1),
    Monster('boss_monster_1', 'monster_boss_1.png', (10, 5), 1, 1),
    Monster('little_monster', 'litel_monster.png', (10, 3), 2, 1),
    Monster('little_monster', 'litel_monster.png', (10, 6), 2, 1),
    Monster('little_monster', 'litel_monster.png', (10, 7), 2, 1),
]
charecters.extend(monsters)


# Карта
map1 = Map(screen_rect, c.MAP_1)
