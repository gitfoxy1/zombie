...
# добавим монстра
m_x = choice([i for i in range(15)])
m_y = choice([i for i in range(10)])
monster1 = Monster.little(name="little_monster_1", xy=[m_x, m_y], game=game)
monster1.start_turn()
...
#  добавить героя
h_x = choice([i for i in range(15)])
h_y = choice([i for i in range(10)])
hero = Hero(name="hero_1", image="hero1.png", xy=[h_x, h_y], game=game)
